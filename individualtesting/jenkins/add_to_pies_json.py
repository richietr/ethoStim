...
if __name__ == '__main__':
    ...
    ap.add_argument("-cd", "--copydelay", help="Delay before copy to shared drive (secs)", required=True)

    args = vars(ap.parse_args())

    pi = args["pi"]
    a_dict = {pi: {"cwtime": args["cwtime"], "ccwtime": args["ccwtime"], "copydelay": args["copydelay"]}}
